class CurriculumsController < ApplicationController
  ...
  def join
    ...
    begin
      ...
      if curriculum.nil?
        flash[:error] = t('join.msg_curriculum_not_found')
        redirect_to home_error_path
        ...
        if !progress.nil?
          ...
          begin
            ...
            materials.each do |material|
              ...
              material_progress.start_date = Date.today
              ...
              material.children.each do |child|
                ...
                child_material_progress.start_date = Date.today
            ...
            curriculum.actions.each do |action|
              ...
              action_progress.start_date = Date.today
    ...
    begin
      ...
      if curriculum.nil?
        ...
        if !curriculum.mentor_id.eql?(user_id)
          ...
          if !curriculum.update_attributes(:curriculum_name => params[:curriculum][:curriculum_name],:summary => params[:curriculum][:summary], :description => params[:curriculum][:description])
            respond_to do |format|
  ...
  def update
    begin
      ...
      if !@curriculum.mentor_id.eql?(user_id)
        ...
        respond_to do |format|
          if update_curriculum(@curriculum)
  ...
  def update_curriculum(curriculum)
    ...
    if !curriculum.update_attributes(:curriculum_name => curriculum.curriculum_name,:summary => curriculum.summary, :description => curriculum.description)
      flash[:error] = curriculum.errors.full_messages
      return false
    end
...
# Never trust parameters from the scary internet, only allow the white list through.
  ...
  # Modify Date:
    def get_curriculum_from_params
      ...
      if !params[:curriculum][:id].nil?
        curriculum._id = BSON::ObjectId.from_string(params[:curriculum][:id] )
      end
      curriculum.curriculum_name = replace_script_tag(params[:curriculum][:curriculum_name])
      curriculum.summary = replace_script_tag(params[:curriculum][:summary])
      curriculum.description = replace_script_tag(params[:curriculum][:description])
  ...
  def get_materials_of_curriculum_from_params(curriculum)
    ...
    if !params[:curriculum][:materials_attributes].nil?
      params[:curriculum][:materials_attributes].values.each do |material_attributes|
        ...
        material.material_name = replace_script_tag(material_attributes[:material_name])
        material.material_url = material_attributes[:material_url]
        material.material_type_id = material_attributes[:material_type_id]
        material.description = replace_script_tag(material_attributes[:description])
  ...
  def get_actions_of_curriculum_from_params(curriculum)
    ...
    if !params[:curriculum][:actions_attributes].nil?
      params[:curriculum][:actions_attributes].values.each do |action_attributes|
        ...
        action.action_name = replace_script_tag(action_attributes[:action_name])
        action.description = replace_script_tag(action_attributes[:description])
